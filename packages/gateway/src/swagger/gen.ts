...
export function connectorMetadata(opts: {
    ...
    (spec as any)["x-ms-connector-metadata"] = [
        {
...
export function route(
    ...
    if ((obj as any)["x-ms-notification-content"]) {
        const notificationContent = (obj as any)["x-ms-notification-content"];
        delete (obj as any)["x-ms-notification-content"];
        (spec.paths[path] as any)["x-ms-notification-content"] = notificationContent;
    }
}
...
export function action(
    ...
    if (currVisibility) (r as any)["x-ms-visibility"] = currVisibility
...
export function trigger(
    ...
    const r: any = action(operationId, summary, description, parameters, {
        "201": {
            description: "Created",
            schema: {},
        },
    ...
    (r as any)["x-ms-trigger"] = "single";

    (r as any)["x-ms-notification-content"] = {
